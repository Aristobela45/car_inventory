...
def signup():
    ...
    try:
        if request.method == 'POST' and form.validate_on_submit():
            ...
            flash(f'You have succesfully created a user account {email}', 'Account have been created')
...
def signin():
    ...
    try: 
        ...
        raise Exception('Invalid Form Data: Please Check Your Form Again and Redo!')
